...
$sql = "INSERT INTO REPORT_MYSIMETRI_DETIL_TRANS (WAKTU_INPUT, WAKTU_TERIMA, WAKTU_SELESAI, C_USER, C_PLASA, C_ANTRIAN, C_SUBLAYANAN, PELANGGAN, NO_ANTRIAN, STATUS, L_USER, VISIT_MSISDN, VISIT_ND, L_LAYANAN, L_PLASA, L_SUBLAYANAN, C_REG, C_WITEL, RNUM, WAKTU_LAYANAN, LAYANAN_2, LAYANAN_3, DETAIL, TANGGAL, PERIODE, TGL_GRAB) VALUES (TO_DATE(:winput,'YYYY-MM-DD HH24:MI:SS'), TO_DATE(:wterima,'YYYY-MM-DD HH24:MI:SS'), TO_DATE(:wselesai,'YYYY-MM-DD HH24:MI:SS'), :cuser, :cplasa, :cantrian, :csublayanan, :pelanggan, :noantrian, :status, :luser, :vmsisdn, :vnd, :llayanan, :lplasa, :lsublayanan, :creg, :cwitel, :rnum, :wlayanan, :layanan2, :layanan3, :detail, TO_DATE(:tang, 'DD-MM-YYYY'), :periode, SYSDATE)";
